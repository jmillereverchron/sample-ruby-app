...
# SonarCloud Scan
| [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=anubx_docker-compose-gh-action&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=anubx_docker-compose-gh-action) | [![Bugs](https://sonarcloud.io/api/project_badges/measure?project=anubx_docker-compose-gh-action&metric=bugs)](https://sonarcloud.io/summary/new_code?id=anubx_docker-compose-gh-action) | [![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=anubx_docker-compose-gh-action&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=anubx_docker-compose-gh-action) | [![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=anubx_docker-compose-gh-action&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=anubx_docker-compose-gh-action) | [![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=anubx_docker-compose-gh-action&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=anubx_docker-compose-gh-action) | [![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=anubx_docker-compose-gh-action&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=anubx_docker-compose-gh-action) |
|-------------|-------------|-------------|-------------|-------------|-------------|
